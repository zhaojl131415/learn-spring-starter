...
//        }
//
//        System.out.println(parameters.get(HTTP_REQUEST_STRING).get(0));
//
...
//                channelGroupMap.get(client.getId()).get(client.getEvent()).writeAndFlush(new TextWebSocketFrame(msg));
//            }
//        }
//    }
//
...
//        System.out.println(ctx.channel().remoteAddress() + "用户登录");
//    }
//
//    @Override
...
//
//        System.out.println("用户注销" + ctx.channel().remoteAddress());
//        System.out.println("当前在线人数:" + channelGroup.size());
